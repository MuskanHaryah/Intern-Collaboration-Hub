    ...
    <div className={`min-h-screen flex items-center justify-center px-4 relative overflow-hidden transition-colors duration-500 ${
      ...
      >
        ...
        <div className={`backdrop-blur-xl rounded-2xl p-8 shadow-2xl border transition-colors duration-500 ${
          ...
          <p className={`mb-6 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Sign in to your account to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center">
              <input
                type="checkbox"
                id="remember"
                className="w-4 h-4 bg-[#1a1a2e] border-white/10 rounded text-purple-500 focus:ring-purple-500 focus:ring-offset-0"
              />
              <label htmlFor="remember" className={`ml-2 text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className={`px-4 ${isDark ? 'bg-[#12121a] text-gray-500' : 'bg-white text-gray-400'}`}>Or continue with</span>
            </div>
          </div>

          {/* Social Login */}
          <div className="grid grid-cols-2 gap-4">
            <button className={`flex items-center justify-center gap-2 px-4 py-3 border rounded-xl transition-all ${
              isDark 
                ? 'bg-[#1a1a2e] border-white/10 text-white hover:bg-[#1a1a2e]/80' 
