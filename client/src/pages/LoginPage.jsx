          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link
                  to="/forgot-password"
                  className={`text-sm transition-colors ${isDark ? 'text-purple-400 hover:text-purple-300' : 'text-purple-600 hover:text-purple-500'}`}
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="flex items-center">
              <input
                ...
                className={`w-4 h-4 rounded text-purple-500 focus:ring-purple-500 focus:ring-offset-0 cursor-pointer ${isDark ? 'bg-[#1a1a2e] border-white/10' : 'bg-white border-gray-300'}`}
              />
