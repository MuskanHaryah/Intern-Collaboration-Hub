        ...
        <div className="bg-[#12121a]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-[#1a1a2e] border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all"
            ...
            <div className="flex items-start">
              <input
                ...
                id="terms"
                required
                className="w-4 h-4 mt-0.5 bg-[#1a1a2e] border-white/10 rounded text-purple-500 focus:ring-purple-500 focus:ring-offset-0"
              />
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#12121a] text-gray-500">Or sign up with</span>
            </div>
          </div>

          {/* Social Login */}
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 px-4 py-3 bg-[#1a1a2e] border border-white/10 rounded-xl text-white hover:bg-[#1a1a2e]/80 transition-all">
